<?php
// Heading
$_['heading_title']       = 'Matomo OpenCart Ecommerce mod';

// Text
$_['text_module']         = 'Modules';
$_['text_success']        = 'Success: You have modified the Matomo OpenCart Ecommerce module!';

$_['text_sku_sku'] = 'Opencart \'SKU\'';
$_['text_sku_model'] = 'Opencart \'Model\'';

// Entry Name Text
$_['entry_enable'] = 'Matomo Tracking';
$_['entry_analytics_url'] = 'Matomo installation URL';
$_['entry_tracker_location'] = 'Full path to PiwikTracker.php';
$_['entry_token_auth'] = 'Matomo auth token';
$_['entry_site_id'] = 'Matomo Site ID';
$_['entry_ec_enable'] = 'Ecommerce tracking';
$_['entry_proxy_enable'] = 'Matomo Proxy Script';
$_['entry_use_sku'] = 'Matomo SKU';

// Entry Help Text #1 (tooltip on hover)
$_['help_enable'] = 'Global on/off setting for the mod.';
$_['help_analytics_url1'] = 'The full URL to your Matomo installation.';
...
$_['help_token_auth1'] = 'Your secret Matomo authorisation token. Get this from your Matomo Admin \'API\' page.';
$_['help_site_id1'] = 'The ID used in your Matomo install, for the site you want to track. Get this from Matomo Admin (Settings -> Websites).';
...
$_['help_analytics_url2'] = 'e.g. www.example.com/matomo/';
$_['help_tracker_location2'] = 'e.g. /home/~user/public_html/matomo/PiwikTracker.php';
$_['help_token_auth2'] = 'e.g. abcde0123456789a0b1c2d3e41234567';
$_['help_site_id2'] = 'e.g. 1';

// Error
$_['error_permission'] = 'Warning: You do not have permission to modify the Matomo OpenCart Ecommerce module!';
